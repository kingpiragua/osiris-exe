...
/**
 * /archive/001 — the recovery ritual for the first recovered memory.
 *
 ...
 */
export default function RecoveredMemory001() {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-xl flex-col items-start px-4 pt-[14vh] pb-24 sm:px-8 sm:pt-[16vh]">
      {phase === "playing" ? (
        ...
        <ArchiveRecord onReady={() => setArmed(true)} />
      )}

      {/* Memory degradation (13%) as faint texture during playback. */}
      {phase === "playing" && (
        <div
          aria-hidden="true"
